...
- (void)setDicItems:(NSArray *)items selectedItemIndex:(NSUInteger)selectedItemIndex {
    _items = items.copy;
    _selectedItemIndex = selectedItemIndex;
...
- (void)setTrackerStyle:(SPPageMenuTrackerStyle)trackerStyle {
    ...
    switch (trackerStyle) {
        ...
        case SPPageMenuTrackerStyleRect:
            ...
            _unSelectedItemTitleColor= [UIColor whiteColor];
            _selectedItemTitleColor = [UIColor whiteColor];
            _dividingLine.hidden=YES;
            self.backgroundColor=[YhbMethods colorWithHexString:COLOR_MAIN];
            break;
        default:
            break;
    }

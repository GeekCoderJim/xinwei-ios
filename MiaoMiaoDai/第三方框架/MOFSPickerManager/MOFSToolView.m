...
//        _titleBar.font = [UIFont systemFontOfSize:14];
        ...
        _titleBar.textColor = [UIColor whiteColor];;
...
//        _commitBar.font = [UIFont systemFontOfSize:14];
        ...
        topLineView.backgroundColor = [YhbMethods colorWithHexString:COLOR_MAIN];
        ...
        bottomLineView.backgroundColor = [YhbMethods colorWithHexString:COLOR_MAIN];
